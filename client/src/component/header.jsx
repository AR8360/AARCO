...
const Header = () => {
  return (
    <header
      id="header"
      className="bg-gradient-to-r flex from-blue-99 to-white text-blue-900 pt-10 md:py-6 px-4 shadow-lg overflow-hidden mt-10 md:mt-20"
      style={{
    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row-reverse items-center justify-center">
        ...
        {/* Logo Section */}
        <div
          className="flex-shrink-0 lg:w-1/3 flex justify-center items-center animate-slide-up"
