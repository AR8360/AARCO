  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row-reverse items-center justify-between">
        {/* Text Section */}
        <div className="text-center lg:text-right mb-12 lg:mb-0 lg:w-2/3">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center lg:justify-end space-y-6 md:space-y-0 md:space-x-8 text-xl"></div>
        </div>
