...
const Header = () => {
    ...
    return (
      <header
        id="header"
        className="flex flex-col items-center justify-center mt-10 md:mt-20 px-4 shadow-lg overflow-hidden"
      >
        {/* Name and Logo Section */}
        <div className="bg-white w-full flex flex-col lg:flex-row items-center justify-center py-6 px-4 shadow-md">
