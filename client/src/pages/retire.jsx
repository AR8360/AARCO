  ...
  const fetchMembers = async () => {
    try {
      ...
      if (response.data.status) {
        ...
        // Assuming retired members are identified by some flag or status in the data
        // If you need to filter retired members, handle it here.
        setMembers(response.data.retirments); // Example filter
      } else {
